...
import { CheckCircle, Layers, Shield, Award, ArrowRight, Phone, Ruler } from 'lucide-react';
import SEO from '../components/SEO';

const FlooringTile: React.FC = () => {
  const benefits = [
    {
      icon: <Layers className="w-8 h-8 text-blue-900" />,
      title: 'Expert Installation',
      description: 'Expert installation of tile, LVP, laminate, and hardwood with precision and attention to detail.'
    },
    {
      icon: <Ruler className="w-8 h-8 text-blue-900" />,
      title: 'Level Substrates',
      description: 'We ensure level substrates and clean lines for a professional finish that lasts.'
    },
    {
      icon: <Shield className="w-8 h-8 text-blue-900" />,
      title: 'Durable Grout',
      description: 'Quality materials and durable grout ensure your flooring stands the test of time.'
    },
    {
      icon: <Award className="w-8 h-8 text-blue-900" />,
      title: 'Quality Materials',
      description: 'We work with premium materials and trusted brands to deliver beautiful, long-lasting results.'
    }
  ];
      ...
      <section className="py-24 bg-white px-4 md:px-16">
        ...
        <div className="mb-20">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              <span className="text-blue-900 font-bold tracking-wider text-sm uppercase">FLOORING & TILE</span>
              <h1 className="text-4xl md:text-5xl font-bold text-gray-900 mt-4 mb-6">
                Phoenix Flooring & Tile Installation | Expert Installation with Level Substrates
              </h1>
              <div className="w-20 h-1 bg-yellow-500 mb-6"></div>
              <p className="text-lg text-gray-600 mb-8 leading-relaxed">
                Expert installation of tile, LVP, laminate, and hardwood. Level substrates, clean lines, durable grout. We deliver beautiful, long-lasting flooring solutions for your home or business.
              </p>
            ...
            <div className="relative">
              <div className="overflow-hidden h-[500px] md:h-[600px] rounded-2xl">
                <img 
                  src="/HMPICTURES/e19a6052-2702-47c2-a024-d3795cdc7a1d.jpg" 
                  alt="Professional Flooring and Tile Installation Services in Phoenix, Arizona" 
        ...
        <div className="mb-20">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-gray-900 mb-4">Why Choose Professional Flooring Installation?</h2>
            <p className="text-gray-600 max-w-2xl mx-auto">
              Professional installation ensures your flooring looks beautiful and performs for years to come.
            </p>
          </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 mb-20">
          <div className="bg-gray-50 rounded-2xl p-8 md:p-10">
            ...
            <p className="text-gray-600 mb-6 leading-relaxed">
              We follow a meticulous process to ensure perfect flooring installation every time.
            </p>
            <ul className="space-y-3">
              <li className="flex items-start">
                <CheckCircle className="w-5 h-5 text-blue-900 mr-3 flex-shrink-0 mt-0.5" />
                <span className="text-gray-700">Free estimate and material consultation</span>
              </li>
              <li className="flex items-start">
                <CheckCircle className="w-5 h-5 text-blue-900 mr-3 flex-shrink-0 mt-0.5" />
                <span className="text-gray-700">Subfloor preparation and leveling</span>
              </li>
              <li className="flex items-start">
                <CheckCircle className="w-5 h-5 text-blue-900 mr-3 flex-shrink-0 mt-0.5" />
                <span className="text-gray-700">Precise measurement and layout</span>
              </li>
              <li className="flex items-start">
                <CheckCircle className="w-5 h-5 text-blue-900 mr-3 flex-shrink-0 mt-0.5" />
                <span className="text-gray-700">Professional installation with clean lines</span>
              </li>
              <li className="flex items-start">
                <CheckCircle className="w-5 h-5 text-blue-900 mr-3 flex-shrink-0 mt-0.5" />
                <span className="text-gray-700">Final inspection and cleanup</span>
              </li>
            </ul>
          </div>
          <div className="bg-gray-50 rounded-2xl p-8 md:p-10">
            ...
            <p className="text-gray-600 mb-6 leading-relaxed">
              We handle all types of flooring installations with precision and care.
            </p>
            <ul className="space-y-3">
              <li className="flex items-start">
                <CheckCircle className="w-5 h-5 text-blue-900 mr-3 flex-shrink-0 mt-0.5" />
                <span className="text-gray-700">Level substrates for perfect results</span>
              </li>
              <li className="flex items-start">
                <CheckCircle className="w-5 h-5 text-blue-900 mr-3 flex-shrink-0 mt-0.5" />
                <span className="text-gray-700">Clean, precise lines and patterns</span>
              </li>
              <li className="flex items-start">
                <CheckCircle className="w-5 h-5 text-blue-900 mr-3 flex-shrink-0 mt-0.5" />
                <span className="text-gray-700">Durable grout and sealants</span>
              </li>
              <li className="flex items-start">
                <CheckCircle className="w-5 h-5 text-blue-900 mr-3 flex-shrink-0 mt-0.5" />
                <span className="text-gray-700">Quality materials and expert craftsmanship</span>
              </li>
            </ul>
          </div>
        </div>
        ...
        <div className="bg-gradient-to-br from-gray-50 to-blue-50 rounded-2xl p-12 md:p-16 text-center">
          ...
          <p className="text-lg text-gray-600 mb-8 max-w-2xl mx-auto">
            Contact us today for a free estimate. Let's create beautiful, durable flooring with expert installation.
          </p>
