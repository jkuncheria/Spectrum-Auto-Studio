...
const CommercialBuildouts: React.FC = () => {
  const benefits = [
    {
      icon: <Clock className="w-8 h-8 text-blue-900" />,
      title: 'Fast & Efficient',
      description: 'Fast, code-compliant build-outs for offices and retail with minimal downtime. Precise schedules keep your business running.'
    },
    {
    ...
    },
    {
      ...
      title: 'Clean Sites',
      description: 'We maintain clean, organized work sites with minimal disruption to your business operations.'
    },
    {
      icon: <Wrench className="w-8 h-8 text-blue-900" />,
      title: 'Transparent Pricing',
      description: 'Clear pricing from demo to final walkthrough. No surprises, just professional service.'
    }
  ];
      ...
      <section className="py-24 bg-white px-4 md:px-16">
        ...
        <div className="mb-20">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              <span className="text-blue-900 font-bold tracking-wider text-sm uppercase">COMMERCIAL BUILD-OUTS & TENANT IMPROVEMENTS</span>
              <h1 className="text-4xl md:text-5xl font-bold text-gray-900 mt-4 mb-6">
                Phoenix Commercial Build-Outs | Fast, Code-Compliant Build-Outs with Minimal Downtime
              </h1>
              <div className="w-20 h-1 bg-yellow-500 mb-6"></div>
              <p className="text-lg text-gray-600 mb-8 leading-relaxed">
                Fast, code-compliant build-outs for offices and retail with minimal downtime. Precise schedules, clean sites, and transparent pricing from demo to final walkthrough.
              </p>
            ...
            <div className="relative">
              <div className="overflow-hidden h-[500px] md:h-[600px] rounded-2xl">
                <img 
                  src="/HMPICTURES/IMG_7866.webp" 
                  alt="Commercial Build-Outs and Tenant Improvements in Phoenix, Arizona" 
        ...
        <div className="mb-20">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-gray-900 mb-4">Why Choose Professional Commercial Build-Outs?</h2>
            <p className="text-gray-600 max-w-2xl mx-auto">
              Professional commercial construction minimizes downtime and maximizes your return on investment.
            </p>
          </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 mb-20">
          <div className="bg-gray-50 rounded-2xl p-8 md:p-10">
            ...
            <p className="text-gray-600 mb-6 leading-relaxed">
              We follow a streamlined process to ensure efficient and code-compliant commercial build-outs.
            </p>
          ...
          <div className="bg-gray-50 rounded-2xl p-8 md:p-10">
            ...
            <p className="text-gray-600 mb-6 leading-relaxed">
              We handle all types of commercial build-outs with professionalism and efficiency.
            </p>
            <ul className="space-y-3">
              <li className="flex items-start">
                <CheckCircle className="w-5 h-5 text-blue-900 mr-3 flex-shrink-0 mt-0.5" />
        ...
        <div className="bg-gradient-to-br from-gray-50 to-blue-50 rounded-2xl p-12 md:p-16 text-center">
          ...
          <p className="text-lg text-gray-600 mb-8 max-w-2xl mx-auto">
            Contact us today for a free estimate. Let's create a space that works for your business with professional commercial build-outs.
          </p>
