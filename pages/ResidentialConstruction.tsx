...
import { CheckCircle, Home, Shield, Clock, ArrowRight, Phone, Hammer, Ruler } from 'lucide-react';
  ...
  const benefits = [
    {
      ...
      title: 'Quality Homes',
      description: 'From remodels to new builds, we deliver quality homes on time and on budget with craftsmanship you can see.'
    },
    {
      icon: <Ruler className="w-8 h-8 text-blue-900" />,
      title: 'Complete Scope Management',
      description: 'We handle scope, permits, inspections, and clear communication—so your project moves smoothly from design to final punch list.'
    },
    {
      icon: <Shield className="w-8 h-8 text-blue-900" />,
      title: 'Licensed & Insured',
      description: 'Our experienced professionals ensure every project is built to last with precision and care, protecting your investment.'
    },
    {
      icon: <Clock className="w-8 h-8 text-blue-900" />,
      title: 'On-Time Delivery',
      description: 'Clear timelines and transparent pricing ensure your project stays on schedule and within budget.'
    }
  ];
      ...
      <section className="py-24 bg-white px-4 md:px-16">
        ...
        <div className="mb-20">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              <span className="text-blue-900 font-bold tracking-wider text-sm uppercase">RESIDENTIAL CONSTRUCTION</span>
              <h1 className="text-4xl md:text-5xl font-bold text-gray-900 mt-4 mb-6">
                Phoenix Residential Construction | Quality Homes Built On Time and On Budget
              </h1>
              <div className="w-20 h-1 bg-yellow-500 mb-6"></div>
              <p className="text-lg text-gray-600 mb-8 leading-relaxed">
                From remodels to new builds, we deliver quality homes on time and on budget. We handle scope, permits, inspections, and clear communication—so your project moves smoothly from design to final punch list.
              </p>
            ...
            <div className="relative">
              <div className="overflow-hidden h-[500px] md:h-[600px] rounded-2xl">
                <img 
                  src="/HMPICTURES/IMG_1679.webp" 
                  alt="Residential Construction Services in Phoenix, Arizona" 
        ...
        <div className="mb-20">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-gray-900 mb-4">Why Choose Professional Residential Construction?</h2>
            <p className="text-gray-600 max-w-2xl mx-auto">
              Professional construction offers quality, reliability, and peace of mind for your home.
            </p>
          </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 mb-20">
          <div className="bg-gray-50 rounded-2xl p-8 md:p-10">
            ...
            <p className="text-gray-600 mb-6 leading-relaxed">
              We follow a streamlined process to ensure efficient and quality construction from start to finish.
            </p>
            <ul className="space-y-3">
              ...
              <li className="flex items-start">
                <CheckCircle className="w-5 h-5 text-blue-900 mr-3 flex-shrink-0 mt-0.5" />
                <span className="text-gray-700">Design and planning phase</span>
              </li>
              <li className="flex items-start">
                <CheckCircle className="w-5 h-5 text-blue-900 mr-3 flex-shrink-0 mt-0.5" />
                <span className="text-gray-700">Permits and approvals</span>
              </li>
              <li className="flex items-start">
                <CheckCircle className="w-5 h-5 text-blue-900 mr-3 flex-shrink-0 mt-0.5" />
                <span className="text-gray-700">Construction with clear communication</span>
              </li>
              <li className="flex items-start">
                <CheckCircle className="w-5 h-5 text-blue-900 mr-3 flex-shrink-0 mt-0.5" />
                <span className="text-gray-700">Final inspection and walkthrough</span>
              </li>
            </ul>
          </div>
          <div className="bg-gray-50 rounded-2xl p-8 md:p-10">
            ...
            <p className="text-gray-600 mb-6 leading-relaxed">
              We handle all types of residential construction projects with the same level of professionalism and care.
            </p>
            <ul className="space-y-3">
              <li className="flex items-start">
                <CheckCircle className="w-5 h-5 text-blue-900 mr-3 flex-shrink-0 mt-0.5" />
              ...
              <li className="flex items-start">
                <CheckCircle className="w-5 h-5 text-blue-900 mr-3 flex-shrink-0 mt-0.5" />
                <span className="text-gray-700">Clear timelines and regular updates</span>
              </li>
              <li className="flex items-start">
                <CheckCircle className="w-5 h-5 text-blue-900 mr-3 flex-shrink-0 mt-0.5" />
                <span className="text-gray-700">Quality craftsmanship you can see</span>
              </li>
            </ul>
          </div>
        </div>
        ...
        <div className="bg-gradient-to-br from-gray-50 to-blue-50 rounded-2xl p-12 md:p-16 text-center">
          ...
          <p className="text-lg text-gray-600 mb-8 max-w-2xl mx-auto">
            Contact us today for a free estimate. Let's turn your vision into reality with professional residential construction.
          </p>
