...
import { Phone, Gift, Users } from 'lucide-react';
import SEO from '../components/SEO';

const MembersPricing: React.FC = () => {
  return (
    <>
      <SEO
        title="Members Pricing | Exclusive Auto Detailing Prices | Old Town Auto Spa"
        ...
        keywords="auto detailing prices, car detailing cost, ceramic coating price, window tinting cost Phoenix"
      ...
      <section className="relative py-12 bg-gradient-to-br from-gray-950 via-stone-900 to-gray-950 px-4 md:px-16 overflow-hidden">
        ...
        <div className="max-w-5xl mx-auto text-center relative z-10">
          <div className="inline-flex items-center gap-2 bg-[#F0E130]/10 border border-[#F0E130]/30 rounded-full px-6 py-2 mb-6">
            ...
            <span className="text-[#F0E130] font-semibold text-sm uppercase tracking-wider">Members Pricing</span>
          </div>
          ...
          <div className="bg-[#F0E130]/10 border border-[#F0E130]/30 rounded-xl p-4 mb-8 max-w-2xl mx-auto">
            <p className="text-[#F0E130] font-bold text-lg mb-1">🎉 Your 20% Discount Applies to ALL Prices Below!</p>
            <p className="text-gray-300 text-sm">Just mention your Facebook group when booking to receive 20% off any service listed on this page.</p>
          </div>
      ...
      <section className="py-16 bg-gray-950 px-4 md:px-16">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="bg-gradient-to-br from-stone-800 to-stone-900 rounded-2xl p-8 border border-[#F0E130]/30">
      ...
      <section className="py-16 bg-stone-900 px-4 md:px-16">
        <div className="max-w-4xl mx-auto">
          <div className="bg-gradient-to-br from-gray-900 to-stone-800 rounded-3xl p-10 md:p-12 text-center border border-[#F0E130]/20">
            <Gift className="w-12 h-12 text-[#F0E130] mx-auto mb-4" />
            <h2 className="text-2xl md:text-3xl font-bold text-white mb-4">
              Ready to Book Your Service?
            </h2>
            <p className="text-gray-400 mb-8 max-w-xl mx-auto">
              Contact us today to schedule your detailing appointment. Don't forget to mention your Facebook group for 20% off!
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link
                to="/contact"
