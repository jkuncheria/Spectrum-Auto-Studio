...
const TempeLiving: React.FC = () => {
  ...
  const benefits = [
    ...
    'Priority scheduling for Tempe Living members',
    'Mobile service - we come to your Tempe location',
    'Premium products trusted by Tempe residents',
  ...
  return (
    <>
      <SEO
        title="Tempe Living Members | Exclusive 20% Off Auto Detailing | Old Town Auto Spa"
        description="Exclusive offer for Tempe Living Facebook group members! Get 20% off all auto detailing services. Ceramic coatings, paint correction, window tinting & more. Call (602) 807-8989 and mention Tempe Living!"
        keywords="Tempe auto detailing discount, Tempe Living special offer, ceramic coating Tempe, auto detailing Tempe AZ, car detailing discount Phoenix"
      ...
      <section className="relative py-16 bg-gradient-to-br from-gray-950 via-stone-900 to-gray-950 px-4 md:px-16 overflow-hidden">
        ...
        <div className="max-w-5xl mx-auto text-center relative z-10">
          ...
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-white mb-6">
            Welcome, <span className="text-[#F0E130]">Tempe Living</span> Members!
          </h1>
          
          <p className="text-xl text-gray-300 mb-4 max-w-3xl mx-auto leading-relaxed">
            This is your private page — a special thank you for being part of the Tempe Living community. 
          ...
          <div className="bg-gradient-to-br from-stone-800 to-stone-900 rounded-3xl p-8 md:p-12 border border-[#F0E130]/30 shadow-2xl max-w-3xl mx-auto mb-10">
            ...
            <p className="text-xl text-white mb-4">
              Just mention <span className="text-[#F0E130] font-bold">"Tempe Living"</span> when booking!
            </p>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-gray-400 max-w-2xl mx-auto">
              All of our premium auto care services are eligible for your 20% Tempe Living discount.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              <h2 className="text-3xl md:text-4xl font-bold text-white mb-6">
                Why Tempe Trusts Old Town Auto Spa
              </h2>
        ...
        <div className="max-w-4xl mx-auto">
          <div className="bg-gradient-to-br from-gray-900 to-stone-800 rounded-3xl p-10 md:p-16 text-center border border-[#F0E130]/20">
            ...
            <p className="text-gray-400 text-lg mb-8 max-w-2xl mx-auto">
              Contact us today and mention <span className="text-[#F0E130] font-bold">"Tempe Living"</span> to receive your exclusive member discount.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link
                to="/contact"
