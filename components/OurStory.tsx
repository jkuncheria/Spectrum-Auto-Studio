  ...
  return (
    <section className="py-24 bg-gradient-to-b from-gray-50 to-white px-4 md:px-16 overflow-hidden">
      <div className="max-w-6xl mx-auto relative">
        ...
        <div className="absolute top-20 left-0 w-64 h-64 rounded-full opacity-10 blur-3xl" style={{ backgroundColor: '#F21C1D' }}></div>
        <div className="absolute bottom-40 right-0 w-96 h-96 rounded-full opacity-10 blur-3xl" style={{ backgroundColor: '#F21C1D' }}></div>
        ...
        <div className="relative z-10">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-16 items-center mb-8">
            <div className="order-2 lg:order-1">
              <div className="bg-white rounded-3xl shadow-xl p-8 md:p-10 border border-gray-100 hover:shadow-2xl transition-shadow duration-300">
                <div className="flex items-center gap-4 mb-6">
                  <div className="p-4 rounded-2xl shadow-lg" style={{ backgroundColor: '#F21C1D' }}>
                    <BookOpen className="w-8 h-8 text-white" />
                  </div>
                  <div>
                    <span className="text-sm font-bold uppercase tracking-wider" style={{ color: '#F21C1D' }}>Chapter 1</span>
                ...
                <div className="space-y-4 text-gray-600 leading-relaxed">
                  ...
                  <p className="text-xl font-bold py-2" style={{ color: '#F21C1D' }}>
                    ✨ And so it began.
                  </p>
                  <p>
            ...
            <div className="order-1 lg:order-2 flex justify-center items-center">
              <div className="relative">
                <div className="w-48 h-48 md:w-64 md:h-64 rounded-full flex items-center justify-center shadow-2xl" style={{ backgroundColor: '#F21C1D' }}>
                ...
                <Sparkles className="absolute -top-4 -right-4 w-10 h-10 text-[#F21C1D]" />
              </div>
            </div>
          </div>
          ...
          <div className="md:hidden flex justify-center my-6">
            <div className="w-1 h-16 rounded-full" style={{ backgroundColor: '#F21C1D' }}></div>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-16 items-center mb-8">
            <div className="flex justify-center items-center">
              <div className="relative">
                <div className="w-48 h-48 md:w-64 md:h-64 rounded-full flex items-center justify-center shadow-2xl bg-gradient-to-br from-[#F21C1D] to-red-700">
                  <div className="text-center text-white">
                ...
                <Users className="absolute -bottom-2 -left-4 w-12 h-12 p-2 rounded-full bg-white shadow-lg" style={{ color: '#F21C1D' }} />
              </div>
            </div>
            <div>
              <div className="bg-white rounded-3xl shadow-xl p-8 md:p-10 border border-gray-100 hover:shadow-2xl transition-shadow duration-300">
                <div className="flex items-center gap-4 mb-6">
                  <div className="p-4 rounded-2xl shadow-lg bg-gradient-to-br from-[#F21C1D] to-red-700">
                    <Users className="w-8 h-8 text-white" />
                  </div>
                  <div>
                    <span className="text-sm font-bold uppercase tracking-wider text-[#F21C1D]">Chapter 2</span>
