...
const Testimonials: React.FC = () => {
    ...
    <>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
        {testimonials.map((testimonial) => (
          ...
          >
            ...
            {testimonial.product && (
              <div className="mb-4">
                <span className="inline-block bg-gray-100 text-gray-900 text-xs font-semibold px-3 py-1 rounded-full">
                  {testimonial.product}
                </span>
              </div>
            )}
      ...
      <div className="mt-16 pt-12 border-t border-gray-200">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
          ...
          <div>
            <div className="text-4xl font-bold text-gray-900 mb-2">10+ Yrs</div>
  ...
  return (
    <section className="py-24 bg-gradient-to-br from-gray-50 via-white to-gray-100 px-4 md:px-16 relative overflow-hidden">
      {/* Decorative Background Elements */}
      <div className="absolute top-0 left-0 w-96 h-96 bg-[#F21C1D] rounded-full opacity-5 blur-3xl"></div>
      <div className="absolute bottom-0 right-0 w-96 h-96 bg-gray-400 rounded-full opacity-5 blur-3xl"></div>
