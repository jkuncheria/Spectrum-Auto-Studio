      ...
      <div className="absolute inset-0 flex flex-col justify-center items-center text-center px-4 md:px-0 z-10">
        ...
        <div className="flex flex-col sm:flex-row gap-4">
          <button 
            ...
            className="bg-[#F21C1D] hover:bg-red-600 text-white font-bold py-3 px-8 rounded shadow-lg transition transform hover:scale-105"
          >
            VIEW OUR SERVICES
          </button>
          <Link 
            to="/contact"
            className="bg-white hover:bg-gray-100 text-black font-bold py-3 px-8 rounded shadow-lg transition transform hover:scale-105 text-center"
          >
            GET FREE QUOTE
          </Link>
        </div>
